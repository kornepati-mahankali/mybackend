      ...
      >
        <div className="flex items-center space-x-3">
          ...
          <div>
            ...
            <p className="text-gray-400">Complete system administration and control</p>
          </div>
        </div>
              ...
              <table className="w-full text-sm">
                <thead>
                  <tr className="border-b border-gray-700">
                    ...
                    <th className="text-left py-3 px-4 text-gray-400 font-medium">Jobs</th>
                ...
                <tbody>
                  {[
                    ...
                    <tr key={user.email} className="border-b border-gray-700/50 hover:bg-gray-700/20">
                      ...
                      <td className="py-3 px-4 text-gray-300">{user.jobs}</td>
                      <td className="py-3 px-4">
